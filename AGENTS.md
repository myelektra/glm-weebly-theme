...
8. **CTA Button** → "Book a Revenue Consultation" (teal green) → /consultation
...
- Transparent background at top → solid background on scroll (>20px)
...
- **Col 4 (Contact):** PT. Myelektra Solusi Indonesia, +62 21 29636761, Get Quote Here, Book Online Meeting, Book a Revenue Consultation CTA
...
| Element | Behavior |
|---|---|
| **Floating CTA** | Appears after 600px scroll, dismissible, shows "Book a Revenue Consultation" |
...
- CTA 1: "Book a Revenue Consultation" → /consultation (teal green)
...
- CTA: "Book a Revenue Consultation" → /consultation

---

### Solutions Page (`/solutions`)
- H1: "Revenue Growth Solutions"
...
- CTA: "Not sure which solution fits? Book a Revenue Consultation"
...
- CTA: "Targeting a Specific Industry? Book a Revenue Consultation"
...
- CTA: "Invest in Your Sales Team's Growth — Book a Revenue Consultation"
...
- H1: "Book a Revenue Consultation"
...
**`content-config.json`** (root project) adalah satu-satunya sumber teks. React app (`src/data/content.ts`) import dari JSON ini. Weebly theme perlu script build terpisah yang generate HTML dari JSON.

### Cara edit teks (no-code)
1. Buka `content-config.json`
2. Cari section yang mau diubah
3. Ganti value string
4. `npm run dev` — auto reload
5. Untuk Weebly: jalankan `npm run build-theme` (tunggu scriptnya dibuat)
...
- Navigation styles (sticky, transparent→solid)
- Hero section, cards, buttons, timeline, grid layouts, footer, forms
...
Right CTA: "Book a Revenue Consultation" (teal green)
